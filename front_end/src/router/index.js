...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/hotel/hotelsearchbybigregion/:bigRegion',
        name: 'hotelsearchbybigregion',
        component: () => import('@/views/hotel/hotelsearchbybigregion')
      },
      {
        path: '/hotel/hotelsearchbyname/:hotelname',
        name: 'hotelsearchbyname',
        component: () => import('@/views/hotel/hotelsearchbyname')
      },
      {
