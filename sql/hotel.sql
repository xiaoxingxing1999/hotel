...
INSERT INTO `Hotel` VALUES (1,'汉庭酒店','欢迎您入住','周边风景优美','汉庭大道','XiDan','Four',1829373819,4.8,1),(2,'儒家酒店','欢迎您入住','南京鼓楼商圈','南京市鼓楼区珠江路268号','WanDa','Four',1829373819,4.8,2),(3,'桂圆酒店','欢迎您入住','景色宜人','南京市栖霞区珠江路268号','XianLin','Four',1829553719,4.8,6);
...
CREATE TABLE `OrderList` (
  ...
  `hasaddcredit` int(255) DEFAULT 0,
  PRIMARY KEY (`id`)
...
INSERT INTO `User` VALUES (4,'1012681@qq.com','123456','测试一号','12345678919',100,'Client'),(5,'123@qq.com','123456','测试二号','12345678911',100,'Client'),(6,'333@qq.com','123456',NULL,NULL,NULL,'HotelManager'),(7,'666@qq.com','123456',NULL,NULL,NULL,'Admin');
