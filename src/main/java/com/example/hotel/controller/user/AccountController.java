...
public class AccountController {
    ...
    @GetMapping("/{id}/getvip")
    public ResponseVO getvip(@PathVariable int id) {
        return ResponseVO.buildSuccess(accountService.getvip(id));
    }
    @GetMapping("/{orderid}/addcredit")
    public ResponseVO addcredit(@PathVariable int orderid){
        return orderService.addcredit(orderid);
    }
